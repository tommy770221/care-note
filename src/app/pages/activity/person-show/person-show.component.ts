    ...
    if(this.user){
      this.careGiverService.queryByEmail('careGivers',this.user.email).then(resp=>{
        if(resp.size!=0){
          ...
          if(this.careGiver && this.careGiver.careTeams && this.careGiver.careTeams.length>0){
